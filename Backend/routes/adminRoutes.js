...
const {getFacultyAssignmentsbyCourse,getAssignmentsByFaculty, getFaculties, getDepartments, getDepartmentTimetable, getRooms} = require("../controller/adminanalysiscontrol")
